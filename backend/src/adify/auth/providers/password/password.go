...
import (
	...
	"adify/auth/claims"
	"adify/auth/providers/password/encryptor"
	"adify/auth/providers/password/encryptor/bcrypt_encryptor"
	"adify/session"
)
...
func (provider Provider) ConfigAuth(auth *auth.Auth) {
	//auth.Render.RegisterViewPath("adify/auth/providers/password/views")
	//
	//if auth.Mailer != nil {
	//	auth.Mailer.RegisterViewPath("adify/auth/providers/password/views/mailers")
	//}
}
